...
class PhotosTableViewCell: UITableViewCell {
    ...
    private func addingLayouts() {
        NSLayoutConstraint.activate([
            ...
            firstPhoto.heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width - 48) / 4),
            ...
            secondPhoto.heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width - 48) / 4),
            ...
            thirdPhoto.heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width - 48) / 4),
            ...
            fourthPhoto.heightAnchor.constraint(equalToConstant: (UIScreen.main.bounds.width - 48) / 4),
