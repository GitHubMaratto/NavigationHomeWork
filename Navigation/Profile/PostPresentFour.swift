...
class PostPresentFour: UIViewController {

    //MARK: - Class Properties Свойства Класса
    
    var likesCountFour: Int = 4325
    var viewsCountFour: Int = 412456545
    ...
    private let authorTextLabel: UILabel = {
        ...
        authorTextLabel.text = "Post with Love"
    ...
    private let imagePostView: UIImageView = {
        ...
        imagePostView.image = UIImage(named: "LoveIsPost")!
    ...
    private let descriptionTextLabel: UILabel = {
        ...
        descriptionTextLabel.text = "Love is..."
    ...
    private lazy var likesView: UILabel = {
        ...
        likesView.text = "Likes: \(String(likesCountFour))"
    ...
    private lazy var viewViews: UILabel = {
        ...
        viewViews.text = "Views: \(String(viewsCountFour))"
