...
class PostPresentThree: UIViewController {

    //MARK: - Class Properties Свойства Класса
    var likesCountThree: Int = 1231
    var viewsCountThree: Int = 14134532752
    ...
    private let imagePostView: UIImageView = {
        ...
        imagePostView.image = UIImage(named: "NicePost")!
    ...
    private let descriptionTextLabel: UILabel = {
        ...
        descriptionTextLabel.text = "Nice Weather Nice Shine"
    ...
    private lazy var likesView: UILabel = {
        ...
        likesView.text = "Likes: \(String(likesCountThree))"
    ...
    private lazy var viewViews: UILabel = {
        ...
        viewViews.text = "Views: \(String(viewsCountThree))"
